# Verified Web3.Storage Upload !WIP!

This repo is dedicated to a Cloudflare workers configuration that acts as a IPFS Gateway that takes an object(10mb max filesize) from a user and uploads it to our Web3.Storage configuration(Users are currently tied to our Web3.Storage account) This is so that user can call the objects they upload from Web3.Storages superfast gateway. This is to provide a complete service from sending the data to us at Leto.gg to recieving the data via the leto's gateway
